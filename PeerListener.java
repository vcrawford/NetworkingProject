...
public class PeerListener extends Thread {
    ...
    /**
     * Constructor. Is called from PeerProcess in order to wait on connections with higher
     * id peers
     */
    public PeerListener(PeerProcess parent, Integer myid, Integer num_wait, ServerSocket listener)
			throws Exception {
	...
	// keep listening until heard from all larger id neighbors
        ...
        try {
	        ...
	        new PeerConnection(this.parent, connection, this.myid).start();
